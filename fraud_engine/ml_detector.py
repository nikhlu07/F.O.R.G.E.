...
class MLFraudDetector:
    ...
    def __init__(self):
        self.model_version = "azure-openai-hybrid-rag-1.0"
    ...
    def predict_fraud_probability(self, claim: Any, historical_data: List[Any], rules_analysis: Any, use_rag: bool = False) -> float:
        ...
        try:
            ...
            retriever = FAISS.from_documents(documents, AzureOpenAIEmbeddings()).as_retriever() if documents else None
            ...
            **Final Fraud Probability Score:**
            ...
            logger.error(f"Hybrid RAG prediction failed: {e}. Is Azure OpenAI configured correctly?")
