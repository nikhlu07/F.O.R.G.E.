...
Note: This requires Azure OpenAI credentials to be configured in your environment, 
as the MLFraudDetector will be called directly.
"""
...
if __name__ == "__main__":
    # Ensure you have your Azure OpenAI environment variables set up before executing this script.
    try:
        asyncio.run(main())
    except Exception as e:
        print(f"\n[ERROR] An error occurred: {e}")
        print("Please ensure your Azure OpenAI environment variables (AZURE_OPENAI_API_KEY, AZURE_OPENAI_ENDPOINT, etc.) are set correctly.")
